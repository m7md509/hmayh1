...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {'اسمي '..(redis:get(KEEPER..'keepernams') or 'تذكار')..' 😌👌','تره اسمي '..(redis:get(KEEPER..'keepernams') or 'تذكار')..' يالجريذي ☹️😹'  }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"هلووووات ","هايات","لا هلا ولا مرحبا شلونك مشتاقين ","اخلاً وصخلا " }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"تمام وانت؟","شعليك انت ؟","مو بخير ):","شدخلك؟" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"تذكار عيشي على التذكار ","صوتي مو حلو للاسف ","اشعجـب كاطع بيه ياراحتي النفسيه ","حرام  الغنا " }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
if text == "باي" or text == "سيو" or text == "رايح" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"بايات ","قلعه ","خذني معك " }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then local KEEPER = {"مووووووووواححح💋😻","مابوس ولي😌😹","خدك نضيف 😂🍃","البوسه بالف حمبي 🌝💋" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"عيـــب 🙀😹","شفيها امك حبي😋🍃" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"تف عليك  😒😹","لا تتفل على وجهك 😻😹","ما اسمحلك  😡😹","بدون تفال رجائاً 😹😹" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"دوم يقلبي انت 😐","ماتطفش من الضحك ","هذا شبي يضحك ؟","اضحك هيه الدنيا خربانه 😂😂" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"لصير عصبي يرتفع ضغطـك 😌😂","صار وجه احمر مثل الطماطه 🙊😹","اوف شحلاتك وانت ضايق😻","شبي هذا الله يستر 😼😹" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
if text == "😒" or text == "😒😒" or text == "😒😒😒" or text == "😒😒😒😒" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {" 🤭😹","يمه زعلان الحلو ما يكلي مرحبا 😻😹","اعدل وجهك لا اعدله الك😼👊🏼" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"يمه  عذبني حبه 🙊😻","عو نضيف الوصخ 😹😹","طفي  عميتني 😼😹" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if text == "💔" or text == "💔💔" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"شفيه مكسور 😔💔","موجوع قلبي والتعب بيه 😔😹","اكل بصل وانسى الي حصل 😻😹" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"وش تبي اطبخ" ,"بقعا رح كل ٰ" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
...
-----------------------------------------
if text == "اقلك" or text == "اكلج" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"شنو؟","لاتقول","قول ياروح تذكار" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
if text == "شفيك" or text == "شفيك انت" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"انت شفيك","شوضعك؟" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
----------------------------------------
if text == "فديتك" or text == "فديت" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"فداك الكون","يعمري احبك","ماااااع" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
---------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"على ساس انت متفاعل","اي عندك اعتراض؟" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
------------------------------------
...
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"كلتراب","كلزق" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
-----------------------------------------
if text == "جيت" or text == "هاي" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"اهلين","توه ينور القروب","اطلق من يجي" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
------------------------------------------------------------
...
if text == "🙊" or text == "🙈" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"اول مره اشوف قرد يستحي","تستحي كثير يعمري" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end

-----------------------------------------
if text == "تذكاار" or text == "تذكار" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"ياقلب وروح تذكار ؟","عيونه","خير؟","شتبي؟","هاه","تراك قروشتني" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
--------------------------------------
if text == "ممكن نتزوج" or text == "ممكن نرتبط" then
if not redis:get(KEEPER..'lock:add'..msg.chat_id_) then
local KEEPER = {"يععع","اانقلع" }
send(msg.chat_id_, msg.id_, 1,''..KEEPER[math.random(#KEEPER)]..'', 1, 'md')
end
end
end
